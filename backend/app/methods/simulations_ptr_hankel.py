...
def simulations_ptr_hankel(
    ...
    for idx, om in enumerate(omega):
        upper = 20.0 / d_pump
        # gęstsze punkty dla bezpieczeństwa
        points = [0.5/d_pump, 1.5/d_pump, 3.0/d_pump, 6.0/d_pump, 10.0/d_pump, 15.0/d_pump]
        ...
        def integrand(lam):
            ...
            try:
                ...
                M3 = layer_matrix(k3, alfa3, 1e6, lam, om, eta=1.0)  # semi-infinite
